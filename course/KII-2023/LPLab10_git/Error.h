...
#define ERROR_THROW_IN(id,l) Error::geterrorin(id,l);
...
#define ERROR_MAX_ENTRY 10000       //количество элементов в таблице ошибок
namespace Error 
{
	...
	ERROR geterrorin(int id, int line);// сформирование ERROR для ERROR_THROW_IN
};
