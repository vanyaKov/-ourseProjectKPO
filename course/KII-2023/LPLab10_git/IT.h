...
#define TI_INT_DEFAULT	0x00000000	// значение по умолчанию дл€ типа uint/bool
#define TI_STR_DEFAULT	0x00		// значение по умолчанию дл€ типа string/char
#define TI_NULLIDX		0xffffffff	// нет элкмента таблицы идентификаторов
#define TI_STR_MAXSIZE	255			// 

namespace IT			// таблица идентификаторов
{
	enum IDDATATYPE { UINT = 1, CHR = 2, BOOL = 3, STRING = 4 };			// типы данных идентификаторов: integer, string
	...
	struct Entry	// строка таблицы идентификаторов
	{
		...
		union
		{
			unsigned int vint;					// значение integer/bool
			struct 
			{
